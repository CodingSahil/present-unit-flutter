class SupabaseClientKeys {
  static const String supabaseUrl = 'https://tjyqbqcbbudxiysjgrgv.supabase.co';
  ...
  static const String assignmentBucketName = 'present-unit-assignment-pdf';
}

class SupabaseTableName {
